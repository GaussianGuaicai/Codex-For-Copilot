...
- `smokeProviderFallback.mjs`: local mock coverage for keeping catalog discovery separate from runtime availability, including direct-error handling when `/responses` rejects a discovered model.
